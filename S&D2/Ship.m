...
- (Ship*)newShip:(NSArray*)params {
    ...
    if(self) {
        ...
        [parts setObject:@"Soldier-Body" forKey:[NSNumber numberWithInt:BODY_TAG]];
        [parts setObject:@"Soldier-Face" forKey:[NSNumber numberWithInt:FACE_TAG]];
        [parts setObject:@"Feet" forKey:[NSNumber numberWithInt:FEET_TAG]];
        [parts setObject:@"Sword" forKey:[NSNumber numberWithInt:WEAPON_TAG]];
...
//    if(attackTarget) {
//        InfantrySprite* sprite = (InfantrySprite*)[self getChildByTag:kAestheticSprite];
